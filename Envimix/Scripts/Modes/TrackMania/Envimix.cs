...
public class Envimix : UniverseModeBase
{
    ...
    public override void OnServerInit()
    {
        ...
        UIManager.UIAll.OverlayChatLineCount = 8;
    ...
    public void CreateServersideLayers()
    {
        ...
        CreateLayer("Checkpoint3", CUILayer.EUILayerType.Normal);
        ...
        for (var i = 0; i < DisplayedCars.Count; i++)
        {
            ...
            vehicleManialink = $"{vehicleManialink}        <quad id=\"QuadVehicleIcon\" pos=\"-34.5 5\" z-index=\"2\" size=\"7.5 7.5\" halign=\"center\" valign=\"center\" image=\"file://Media/Images/Cars/{vehicle}.png\"/>";
        ...
        loadingManialink = $"{loadingManialink}        <quad pos=\"0 -0.5\" size=\"180 26\" halign=\"center\" valign=\"center\" image=\"file://Media/Images/Envimix.png\" z-index=\"2\"/>";
