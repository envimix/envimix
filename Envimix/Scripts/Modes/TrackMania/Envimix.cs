...
public class Envimix : UniverseModeBase
{
    ...
    public void CreateServersideLayers()
    {
        ...
        for (var i = 0; i < DisplayedCars.Count; i++)
        {
            ...
            vehicleManialink = $"{vehicleManialink}        <quad id=\"QuadVehicleIcon\" pos=\"-34.5 5\" z-index=\"2\" size=\"7.5 7.5\" halign=\"center\" valign=\"center\" image=\"https://envimix.gbx.tools/img/cars/{vehicle}.png\"/>";
