...
public class _321GoViewGhost : CTmMlScriptIngame, IContext
{
    ...
    [Netread] public required int RaceStartTime { get; set; }
    ...
    bool IsVisible()
    {
        return GameTime - RaceStartTime > -3000;
    }
    ...
    public void Loop()
    {
        ...
        var time = GameTime - RaceStartTime;
