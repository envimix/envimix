...
public class EnvimixSingleplayerClient : CManiaAppPlayground, IContext
{
    ...
    public void Main()
    {
        ...
        for (var i = 0; i < displayedCars.Get().Count; i++)
        {
            ...
            vehicleManialink = $"{vehicleManialink}        <quad pos=\"-34.5 5\" z-index=\"2\" id=\"QuadVehicleIcon\" size=\"7.5 7.5\" halign=\"center\" valign=\"center\" image=\"file://Media/Images/Cars/{vehicle}.png\"/>";
